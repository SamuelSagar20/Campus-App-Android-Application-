...
public class Semester_6_cse_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semester_6_cse_);

        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.sem_6_recycler);

        //Query
        Query query = firebaseFirestore.collection("SEMESTER_6_CSE");
        ...
        adapter = new FirestoreRecyclerAdapter<firestore_examDetails_access, ProductsViewHolder>(options) {
            @NonNull
            @Override
            ...
            @Override
            protected void onBindViewHolder(@NonNull ProductsViewHolder holder, int position, @NonNull firestore_examDetails_access model) {
